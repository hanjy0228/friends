...
<div class="user_main">
    ...
    <div class="main_right">
        ...
        <div class="oe_tab_nv">
            <ul>
                <li class="tab_item "><a href="/index/self_message">会员来信</a></li>
                <li class="tab_item current"><a href="/index/self_get_message">已发私信</a></li>
            </ul>
        </div>
        ...
        <div class="div_smallnav_content_hover">
            ...
            <div class="nav-tips">
                <div class="span">发送信件{{$count}}封</div>

            </div>
            <form action="http://www.wzqsys.com/usercp.php?c=message&amp;type=" method="post" name="myform" id="myform">
