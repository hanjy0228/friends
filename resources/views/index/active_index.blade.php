        ...
        <div class="main_right">
            ...
            <div class="oe_tab_nv">
                <ul>
                    ...
                    <li class="tab_item current"><a href="/index/active_index">配对成功爱豆</a></li>
                    <li class="tab_item "><a href="/index/self">返回</a></li>
                </ul>
            </div>
            ...
            <div class="div_smallnav_content_hover">
                ...
                <table class="table">
                    <tbody>
                    <p style="color: deeppink ; font-size: 30px;">不见不散</p>
                    <dl class="cin">
                        <dt>
                            <a href="http://www.wzqsys.com/home/162252" target="_blank"><img src="/uploads/{{$data->img}}" style="width: 80px; height: 80px;"></a>
                            <a href="http://www.wzqsys.com/home/162252"
                               target="_blank"> &nbsp; &nbsp;昵称：{{$data->nichen}}</a><span>&nbsp;&nbsp;&nbsp;年龄:{{$data->age}}
                            </span>
                            <label>&nbsp;&nbsp;&nbsp;身高 {{$data->height}}</label>
                        </dt>
                        <dt>
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="button"  value="点击报名"class="button-red" id="act_peo">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="button"  value="参加任务"class="button-red" id="peo">
            ...
            <div class="popwin-menu">
                <ul>
                    ...
                    <li onclick="obj_click_menu(&#39;hi&#39;, &#39;1&#39;, &#39;我的招呼&#39;);">
                        <div class="popwin-tx block"></div><img src="/index/img/popwin_hi.gif">招呼<span
                                id="popwinhi"><script>obj_loading_count('hi', 'popwinhi');</script></span>
                    </li>
...
<script>
    $("#peo").click(function () {
            $.ajax({
                ...
                {
                    window.location = '/index/actives'
                }
            });

        }
    );
    $("#act_peo").click(function () {
            $.ajax({
                url: "/index/char_list",
            }).done(function( msg ) {
                if(msg == 0)
